package com.alramlawi.schoolapp.parent.settings;
...
public class SettingsFragment extends Fragment {
    ...
    String HttpURL = "https://schoolmanager000.000webhostapp.com/UserLogin/update_LoginParent.php";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Idholder = getActivity().getIntent().getExtras().getString("std_id");
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(CheckEditText){
                    ...
                    updatePass(NameHolder, PasswordHolder, pass2);
                }
                else {
