...
public class ParentAdapter extends ArrayAdapter<Approval> {
    Context context;
    int resource;

    public ParentAdapter(@NonNull Context context, int resource, @NonNull List<Approval> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView tvType = (TextView)convertView.findViewById(R.id.msg_type4);
        TextView tvTitle = (TextView)convertView.findViewById(R.id.msg_title4);
        TextView tvTxt = (TextView)convertView.findViewById(R.id.msg_details4);
        TextView pdf = (TextView)convertView.findViewById(R.id.pdf_path4);
        TextView tvDate = (TextView)convertView.findViewById(R.id.msg_date4);
        Button share = convertView.findViewById(R.id.share_btn2);
